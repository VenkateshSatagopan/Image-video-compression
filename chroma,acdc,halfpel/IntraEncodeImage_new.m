function [ sequence,sizes_full] = IntraEncodeImage_new( image_Y, image_Cb, image_Cr, q_factor,block_divide_factor)
...
[zero_y, zero_cb, zero_cr, dc_y, dc_cb, dc_cr]= IntraEncodeBlock(coding_block_y, coding_block_cb, coding_block_cr, q_factor);
