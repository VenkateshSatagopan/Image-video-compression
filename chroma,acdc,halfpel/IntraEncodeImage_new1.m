function [ sequence,sizes_full] = IntraEncodeImage_new1( image_Y, image_Cb, image_Cr, q_factor,block_divide_factor,option)
...
[zero_y, zero_cb, zero_cr]= IntraEncodeBlocknew(coding_block_y, coding_block_cb, coding_block_cr, q_factor,option);
...
% dc_sequence_new=ZeroRunEncnew(dc_sequence);
